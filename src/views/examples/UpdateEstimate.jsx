...
class UpdateEstimate extends React.Component {
    ...
    render() {
        ...
        return ( <
            ...
            FormGroup >
            <
            label className = "form-control-label d-inline-block"
            htmlFor = "input-name" >
            Client Name <
            /label> <
            ...
            tbody > {
                this.state.items.map((el, i) => ( <
                    ...
                    style = {
                        { width: '100px', height: '20px', fontSize: '10px', paddingTop: '0' }
                    }
            ...
            Comments <
            /label> <
            Input defaultValue = { `${this.state.comments}` }
            name = "comments"
            className = "form-control-alternative"
            ...
            Date Create <
            /label> <
            Input defaultValue = { `${this.state.dateCreate}` }
            name = "dateCreate"
            className = "form-control-alternative"
            type = "text"
            onChange = { this.handleInput }
            ...
            <
            Button className = "form-control-alternative"
            color = "info"
